            ...
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-3">
                            <div class="mini-stat clearfix">
                                <span id="item2" class="mini-stat-icon tar"><i class="fa fa-upload"></i></span>
                                <div class="mini-stat-info">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <div class="top-stats-panel box_entrada">
                                ...
                                <button id="saida1" type="button" onclick="postParemeter('a');" class="btn btn-info btn-lg btn-block">Ligar|Desligar</button>
                            </div>
                        </div>
                    </section>
                </div>
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <div class="top-stats-panel box_entrada">
                                ...
                                <button id="saida2" type="button" onclick="postParemeter('b');" class="btn btn-info btn-lg btn-block">Ligar|Desligar</button>
                            </div>
                        </div>
                    </section>
                </div>
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <div class="top-stats-panel box_entrada">
                                ...
                                <button id="saida3" type="button" onclick="postParemeter('c');" class="btn btn-info btn-lg btn-block">Ligar|Desligar</button>
                            </div>
                        </div>
                    </section>
                </div>
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <div class="top-stats-panel box_entrada">
                                ...
                                <button id="saida4" type="button" onclick="postParemeter('d');" class="btn btn-info btn-lg btn-block">Ligar|Desligar</button>
                            </div>
                        </div>
                    </section>
                </div> 
...
<script>
    ...
    function desabilitarItens(){
        document.getElementById("item1").className = "mini-stat-icon";
        document.getElementById("item2").className = "mini-stat-icon";
        document.getElementById("item3").className = "mini-stat-icon";
        document.getElementById("item4").className = "mini-stat-icon";

        document.getElementById("entrada1").className = "btn btn-default btn-lg btn-block";
        document.getElementById("entrada2").className = "btn btn-default btn-lg btn-block";
        document.getElementById("entrada3").className = "btn btn-default btn-lg btn-block";
        document.getElementById("entrada4").className = "btn btn-default btn-lg btn-block";

        document.getElementById("saida1").className = "btn btn-default btn-lg btn-block";
        document.getElementById("saida2").className = "btn btn-default btn-lg btn-block";
        document.getElementById("saida3").className = "btn btn-default btn-lg btn-block";
        document.getElementById("saida4").className = "btn btn-default btn-lg btn-block";
    }

    function habilitarItens(){
        document.getElementById("item1").className = "mini-stat-icon yellow-b";
        document.getElementById("item2").className = "mini-stat-icon tar";
        document.getElementById("item3").className = "mini-stat-icon pink";
        document.getElementById("item4").className = "mini-stat-icon green";

        document.getElementById("entrada1").className = "btn btn-default btn-lg btn-block btn-danger";
        document.getElementById("entrada2").className = "btn btn-default btn-lg btn-block btn-danger";
        document.getElementById("entrada3").className = "btn btn-default btn-lg btn-block btn-danger";
        document.getElementById("entrada4").className = "btn btn-default btn-lg btn-block btn-danger";

        document.getElementById("saida1").className = "btn btn-default btn-lg btn-block btn-info";
        document.getElementById("saida2").className = "btn btn-default btn-lg btn-block btn-info";
        document.getElementById("saida3").className = "btn btn-default btn-lg btn-block btn-info";
        document.getElementById("saida4").className = "btn btn-default btn-lg btn-block btn-info";
    }
